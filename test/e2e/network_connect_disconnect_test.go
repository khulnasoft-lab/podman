...
var _ = Describe("Podman network connect and disconnect", func() {
	...
	It("podman network disconnect", func() {
		...
		// make sure stats still works https://github.com/khulnasoft-lab/podman/issues/13824
	...
	It("podman network connect", func() {
		...
		// make sure stats works https://github.com/khulnasoft-lab/podman/issues/13824
		stats := podmanTest.Podman([]string{"stats", "test", "--no-stream"})
		stats.WaitWithDefaultTimeout()
		Expect(stats).Should(Exit(0))

		// make sure no logrus errors are shown https://github.com/khulnasoft-lab/podman/issues/9602
