...
# https://github.com/khulnasoft-lab/podman/issues/13153
...
EOF
    ...
    # khulnasoft-lab/podman/issues/17482: verify that the log-driver for the Pod's containers is NOT passthrough
    for name in "a" "b"; do
