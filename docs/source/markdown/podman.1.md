...
On remote clients, including Mac and Windows (excluding WSL2) machines, logging is directed to the file $HOME/.config/khulnasoft-lab/podman.log.
...
For more information, see the [Podman Troubleshooting Page](https://github.com/khulnasoft-lab/podman/blob/main/troubleshooting.md).
