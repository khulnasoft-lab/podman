...
If you are running on a Mac or Windows PC, you should instead follow the [Mac and Windows tutorial](https://github.com/khulnasoft-lab/podman/blob/main/docs/tutorials/mac_win_client.md)
