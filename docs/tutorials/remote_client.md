...
This tutorial is for running Podman remotely on Linux. If you are using a Mac or a Windows PC, please follow the [Mac and Windows tutorial](https://github.com/khulnasoft-lab/podman/blob/main/docs/tutorials/mac_win_client.md)
...
If you would like to install only the podman-remote client, it is downloadable from its [release description page](https://github.com/khulnasoft-lab/podman/releases/latest).  You can also build it from source using the `make podman-remote`
...
## History
Adapted from the [Mac and Windows tutorial](https://github.com/khulnasoft-lab/podman/blob/main/docs/tutorials/mac_win_client.md)
