...
<span class='bats-log'># (from function `assert&#39; in file ./<a class="codelink" href="https://github.com/khulnasoft-lab/podman/blob/ceci-nest-pas-une-sha/test/system/helpers.bash#L343">helpers.bash, line 343</a>,</span>
<span class='bats-log'>#  from function `expect_output&#39; in file ./<a class="codelink" href="https://github.com/khulnasoft-lab/podman/blob/ceci-nest-pas-une-sha/test/system/helpers.bash#L370">helpers.bash, line 370</a>,</span>
<span class='bats-log'>#  in test file ./<a class="codelink" href="https://github.com/khulnasoft-lab/podman/blob/ceci-nest-pas-une-sha/test/system/run.bats#L786">run.bats, line 786</a>)</span>
...
<span class="timestamp">         </span><span class='bats-log'># (from function `die&#39; in file test/system/<a class="codelink" href="https://github.com/khulnasoft-lab/podman/blob/ceci-nest-pas-une-sha/test/system/helpers.bash#L564">helpers.bash, line 564</a>,</span>
<span class="timestamp">         </span><span class='bats-log'>#  from function `run_podman&#39; in file test/system/<a class="codelink" href="https://github.com/khulnasoft-lab/podman/blob/ceci-nest-pas-une-sha/test/system/helpers.bash#L245">helpers.bash, line 245</a>,</span>
<span class="timestamp">         </span><span class='bats-log'>#  in test file test/system/<a class="codelink" href="https://github.com/khulnasoft-lab/podman/blob/ceci-nest-pas-une-sha/test/system/888-foo.bats#L15">888-foo.bats, line 15</a>)</span>
...
[+0004s] CGO_ENABLED=1 GOOS=linux GOARCH=amd64 go build  -ldflags '-X github.com/khulnasoft-lab/podman/v4/libpod/define.gitCommit=074143b0fac7af72cd92048d27931a92fe745084 -X github.com/khulnasoft-lab/podman/v4/libpod/define.buildInfo=1681728432 -X github.com/khulnasoft-lab/podman/v4/libpod/config._installPrefix=/usr/local -X github.com/khulnasoft-lab/podman/v4/libpod/config._etcDir=/usr/local/etc -X github.com/khulnasoft-lab/podman/v4/pkg/systemd/quadlet._binDir=/usr/local/bin -X github.com/containers/common/pkg/config.additionalHelperBinariesDir= ' -tags "   selinux systemd  exclude_graphdriver_devicemapper seccomp" -o test/checkseccomp/checkseccomp ./test/checkseccomp
[+0006s] CGO_ENABLED=1 GOOS=linux GOARCH=amd64 go build  -ldflags '-X github.com/khulnasoft-lab/podman/v4/libpod/define.gitCommit=074143b0fac7af72cd92048d27931a92fe745084 -X github.com/khulnasoft-lab/podman/v4/libpod/define.buildInfo=1681728434 -X github.com/khulnasoft-lab/podman/v4/libpod/config._installPrefix=/usr/local -X github.com/khulnasoft-lab/podman/v4/libpod/config._etcDir=/usr/local/etc -X github.com/khulnasoft-lab/podman/v4/pkg/systemd/quadlet._binDir=/usr/local/bin -X github.com/containers/common/pkg/config.additionalHelperBinariesDir= ' -o test/goecho/goecho ./test/goecho
[+0006s] ./hack/install_catatonit.sh
[+0270s] ------------------------------
[+0271s] • [3.327 seconds]
[+0271s] Podman restart
[+0271s] /var/tmp/go/src/github.com/khulnasoft-lab/podman/test/e2e/restart_test.go:14
[+0271s]   podman restart non-stop container with short timeout
[+0271s]   /var/tmp/go/src/github.com/khulnasoft-lab/podman/test/e2e/restart_test.go:148
[+0271s]&TRAILINGSPACE;
[+0271s]   Timeline >>
[+0271s]   > Enter [BeforeEach] Podman restart - /var/tmp/go/src/github.com/khulnasoft-lab/podman/test/e2e/restart_test.go:21 @ 04/17/23 10:00:28.653
[+0271s]   < Exit [BeforeEach] Podman restart - /var/tmp/go/src/github.com/khulnasoft-lab/podman/test/e2e/restart_test.go:21 @ 04/17/23 10:00:28.653 (0s)
[+0271s]   > Enter [It] podman restart non-stop container with short timeout - /var/tmp/go/src/github.com/khulnasoft-lab/podman/test/e2e/restart_test.go:148 @ 04/17/23 10:00:28.653
[+0271s]   Running: /var/tmp/go/src/github.com/khulnasoft-lab/podman/bin/podman --storage-opt vfs.imagestore=/tmp/imagecachedir --root /tmp/podman_test2968516396/root --runroot /tmp/podman_test2968516396/runroot --runtime crun --conmon /usr/bin/conmon --network-config-dir /tmp/podman_test2968516396/root/etc/networks --network-backend netavark --cgroup-manager systemd --tmpdir /tmp/podman_test2968516396 --events-backend file --db-backend sqlite --storage-driver vfs run -d --name test1 --env STOPSIGNAL=SIGKILL quay.io/libpod/alpine:latest sleep 999
...
[+0271s]   test1
[+0271s]   < Exit [It] podman restart non-stop container with short timeout - /var/tmp/go/src/github.com/khulnasoft-lab/podman/test/e2e/restart_test.go:148 @ 04/17/23 10:00:31.334 (2.681s)
[+0271s]   > Enter [AfterEach] Podman restart - /var/tmp/go/src/github.com/khulnasoft-lab/podman/test/e2e/restart_test.go:30 @ 04/17/23 10:00:31.334
...
[+0271s]   7f5f8fb3d043984cdff65994d14c4fd157479d20e0a0fcf769c35b50e8975edc
[+0271s]   < Exit [AfterEach] Podman restart - /var/tmp/go/src/github.com/khulnasoft-lab/podman/test/e2e/restart_test.go:30 @ 04/17/23 10:00:31.979 (645ms)
[+0271s]   << Timeline
[+0296s] ------------------------------
[+0298s] • [FAILED] [6.071 seconds]
[+0298s] TOP-LEVEL [AfterEach]
[+0298s] /var/tmp/go/src/github.com/khulnasoft-lab/podman/test/e2e/common_test.go:117
[+0298s]   Podman pod create
[+0298s]   /var/tmp/go/src/github.com/khulnasoft-lab/podman/test/e2e/pod_infra_container_test.go:12
[+0298s]     podman pod correctly sets up PIDNS
[+0298s]     /var/tmp/go/src/github.com/khulnasoft-lab/podman/test/e2e/pod_infra_container_test.go:154
...
[+1741s]   /var/tmp/go/src/github.com/khulnasoft-lab/podman/test/e2e/common_test.go:657
[+1741s]&TRAILINGSPACE;
[+1741s] Ran 1889 of 2014 Specs in 1607.919 seconds
[+1741s] FAIL! -- 1881 Passed | 1 Failed | 0 Pending | 125 Skipped
>>>
[05:47:08] START - All [+xxxx] lines that follow are relative to 2023-04-17T05:47:08.
<span class="timestamp">[+0004s] </span>CGO_ENABLED=1 GOOS=linux GOARCH=amd64 go build  -ldflags &#39;-X github.com/khulnasoft-lab/podman/v4/libpod/define.gitCommit=074143b0fac7af72cd92048d27931a92fe745084 -X github.com/khulnasoft-lab/podman/v4/libpod/define.buildInfo=1681728432 -X github.com/khulnasoft-lab/podman/v4/libpod/config._installPrefix=/usr/local -X github.com/khulnasoft-lab/podman/v4/libpod/config._etcDir=/usr/local/etc -X github.com/khulnasoft-lab/podman/v4/pkg/systemd/quadlet._binDir=/usr/local/bin -X github.com/containers/common/pkg/config.additionalHelperBinariesDir= &#39; -tags &quot;   selinux systemd  exclude_graphdriver_devicemapper seccomp&quot; -o test/checkseccomp/checkseccomp ./test/checkseccomp
...
<span class="timestamp">         </span>/var/tmp/go/src/github.com<a class="codelink" href='https://github.com/khulnasoft-lab/podman/blob/074143b0fac7af72cd92048d27931a92fe745084/test/e2e/restart_test.go#L14'>/khulnasoft-lab/podman/test/e2e/restart_test.go:14</a>
...
<span class="timestamp">         </span>  /var/tmp/go/src/github.com<a class="codelink" href='https://github.com/khulnasoft-lab/podman/blob/074143b0fac7af72cd92048d27931a92fe745084/test/e2e/restart_test.go#L148'>/khulnasoft-lab/podman/test/e2e/restart_test.go:148</a>
<span class="timestamp">         </span>
<span class="timestamp">         </span>  Timeline &gt;&gt;
<div class="ginkgo-timeline ginkgo-beforeeach"><span class="timestamp">         </span>  &rarr; Enter [<b>BeforeEach</b>] Podman restart - /var/tmp/go/src/github.com<a class="codelink" href='https://github.com/khulnasoft-lab/podman/blob/074143b0fac7af72cd92048d27931a92fe745084/test/e2e/restart_test.go#L21'>/khulnasoft-lab/podman/test/e2e/restart_test.go:21</a> @ 04/17/23 10:00:28.653
<span class="timestamp">         </span>  &larr; Exit  [BeforeEach] Podman restart - /var/tmp/go/src/github.com<a class="codelink" href='https://github.com/khulnasoft-lab/podman/blob/074143b0fac7af72cd92048d27931a92fe745084/test/e2e/restart_test.go#L21'>/khulnasoft-lab/podman/test/e2e/restart_test.go:21</a> @ 04/17/23 10:00:28.653 (0s)
</div><div class="ginkgo-timeline ginkgo-it"><span class="timestamp">         </span>  &rarr; Enter [<b>It</b>] podman restart non-stop container with short timeout - /var/tmp/go/src/github.com<a class="codelink" href='https://github.com/khulnasoft-lab/podman/blob/074143b0fac7af72cd92048d27931a92fe745084/test/e2e/restart_test.go#L148'>/khulnasoft-lab/podman/test/e2e/restart_test.go:148</a> @ 04/17/23 10:00:28.653
<span class="timestamp">         </span><span class="boring">  #</span> <span title="/var/tmp/go/src/github.com/khulnasoft-lab/podman/bin/podman"><b>podman</b></span> <span class="boring" title="--storage-opt vfs.imagestore=/tmp/imagecachedir
...
<span class="timestamp">         </span>  &larr; Exit  [It] podman restart non-stop container with short timeout - /var/tmp/go/src/github.com<a class="codelink" href='https://github.com/khulnasoft-lab/podman/blob/074143b0fac7af72cd92048d27931a92fe745084/test/e2e/restart_test.go#L148'>/khulnasoft-lab/podman/test/e2e/restart_test.go:148</a> @ 04/17/23 10:00:31.334 (2.681s)
</div><div class="ginkgo-timeline ginkgo-aftereach"><span class="timestamp">         </span>  &rarr; Enter [<b>AfterEach</b>] Podman restart - /var/tmp/go/src/github.com<a class="codelink" href='https://github.com/khulnasoft-lab/podman/blob/074143b0fac7af72cd92048d27931a92fe745084/test/e2e/restart_test.go#L30'>/khulnasoft-lab/podman/test/e2e/restart_test.go:30</a> @ 04/17/23 10:00:31.334
<span class="timestamp">         </span><span class="boring">  #</span> <span title="/var/tmp/go/src/github.com/khulnasoft-lab/podman/bin/podman"><b>podman</b></span> <span class="boring" title="--storage-opt vfs.imagestore=/tmp/imagecachedir
--root /tmp/podman_test2968516396/root
--runroot /tmp/podman_test2968516396/runroot
--runtime crun
...
<span class="timestamp">         </span>  7f5f8fb3d043984cdff65994d14c4fd157479d20e0a0fcf769c35b50e8975edc
<span class="timestamp">         </span>  &larr; Exit  [AfterEach] Podman restart - /var/tmp/go/src/github.com<a class="codelink" href='https://github.com/khulnasoft-lab/podman/blob/074143b0fac7af72cd92048d27931a92fe745084/test/e2e/restart_test.go#L30'>/khulnasoft-lab/podman/test/e2e/restart_test.go:30</a> @ 04/17/23 10:00:31.979 (645ms)
...
<span class="timestamp">         </span>/var/tmp/go/src/github.com<a class="codelink" href='https://github.com/khulnasoft-lab/podman/blob/074143b0fac7af72cd92048d27931a92fe745084/test/e2e/common_test.go#L117'>/khulnasoft-lab/podman/test/e2e/common_test.go:117</a>
<span class="timestamp">         </span><a name='t--Podman-pod-create--1'><h2 class="log-failed">  Podman pod create</h2></a>
<span class="timestamp">         </span>  /var/tmp/go/src/github.com<a class="codelink" href='https://github.com/khulnasoft-lab/podman/blob/074143b0fac7af72cd92048d27931a92fe745084/test/e2e/pod_infra_container_test.go#L12'>/khulnasoft-lab/podman/test/e2e/pod_infra_container_test.go:12</a>
...
<span class="timestamp">         </span>    /var/tmp/go/src/github.com<a class="codelink" href='https://github.com/khulnasoft-lab/podman/blob/074143b0fac7af72cd92048d27931a92fe745084/test/e2e/pod_infra_container_test.go#L154'>/khulnasoft-lab/podman/test/e2e/pod_infra_container_test.go:154</a>
...
<span class="timestamp">         </span>  /var/tmp/go/src/github.com<a class="codelink" href='https://github.com/khulnasoft-lab/podman/blob/074143b0fac7af72cd92048d27931a92fe745084/test/e2e/common_test.go#L657'>/khulnasoft-lab/podman/test/e2e/common_test.go:657</a>
<span class="timestamp">         </span>
...
<<<
[+0234s] env CONTAINERS_CONF=/var/tmp/go/src/github.com/khulnasoft-lab/podman/test/apiv2/containers.conf PODMAN=./bin/podman /usr/bin/python3 -m unittest discover -v ./test/python/docker
...
[+0299s]   File "/var/tmp/go/src/github.com/khulnasoft-lab/podman/test/python/docker/compat/test_images.py", line 90, in test_search_image
...
>>>
<span class="timestamp">[+0234s] </span>env CONTAINERS_CONF=/var/tmp/go/src/github.com/khulnasoft-lab/podman/test/apiv2/containers.conf PODMAN=./bin/podman /usr/bin/python3 -m unittest discover -v ./test/python/docker
...
<span class="timestamp">         </span>  File &quot;/var/tmp/go/src/github.com<a class="codelink" href='https://github.com/khulnasoft-lab/podman/blob/ceci-nest-pas-une-sha/test/python/docker/compat/test_images.py#L90'>/khulnasoft-lab/podman/test/python/docker/compat/test_images.py&quot;, line 90</a>, in test_search_image
