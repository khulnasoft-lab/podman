...
import (
	...
	"github.com/khulnasoft-lab/podman/v4/pkg/systemd/quadlet"
	"github.com/khulnasoft-lab/podman/v4/version/rawversion"
)
...
func process() error {
	...
	if len(units) == 0 {
		// khulnasoft-lab/podman/issues/17374: exit cleanly but log that we
		// had nothing to do
